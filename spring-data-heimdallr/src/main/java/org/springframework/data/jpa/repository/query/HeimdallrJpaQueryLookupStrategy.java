...
public class HeimdallrJpaQueryLookupStrategy {
    ...
    private static class CreateQueryLookupStrategy extends AbstractQueryLookupStrategy {
        ...
        protected RepositoryQuery resolveQuery(JpaQueryMethod method, EntityManager em, NamedQueries namedQueries) {
            return new HeimdallrPartTreeJpaQuery(method, em, escape);
        }
    }
    ...
    private static class DeclaredQueryLookupStrategy extends AbstractQueryLookupStrategy {
        ...
        protected RepositoryQuery resolveQuery(JpaQueryMethod method, EntityManager em, NamedQueries namedQueries) {
            ...
            if (StringUtils.hasText(method.getAnnotatedQuery())) {
                ...
                return HeimdallrJpaQueryFactory.INSTANCE.fromMethodWithQueryString(method, em, method.getRequiredAnnotatedQuery(),
            ...
            if (namedQueries.hasQuery(name)) {
                return HeimdallrJpaQueryFactory.INSTANCE.fromMethodWithQueryString(method, em, namedQueries.getQuery(name), getCountQuery(method, namedQueries, em),
                        evaluationContextProvider);
            }
